  ...
  return (
    <div className="md:ml-64 min-h-screen pb-24 md:pb-0">
      ...
      <div className="bg-gradient-to-br from-blue-50 to-indigo-50 px-4 pt-4 pb-6 md:px-8 sticky top-0 z-10">
        ...
        <h1 className="heading-lg">💳 Transaksi</h1>
        <p className="text-gray-600 mt-2">Lihat semua pengeluaran dan pemasukan</p>
      </div>
      ...
      <div className="px-4 md:px-8 py-6">
        <div className="card p-12 text-center">
          ...
          <p className="text-gray-500">Halaman Transaksi akan segera tersedia</p>
        </div>
      </div>
